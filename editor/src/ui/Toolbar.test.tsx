...
describe('Toolbar', () => {
    test('renders brand and four buttons', () => {
        render(<Toolbar engineState="idle" canPlay onPlay={() => {}} onStop={() => {}} onClear={() => {}} onDownload={() => {}} onOpen={() => {}} />);
    ...
    test('Play is disabled when canPlay is false', () => {
        render(<Toolbar engineState="idle" canPlay={false} onPlay={() => {}} onStop={() => {}} onClear={() => {}} onDownload={() => {}} onOpen={() => {}} />);
    ...
    test('clicking Play, Open, Download fires their callbacks', async () => {
        ...
        render(<Toolbar engineState="idle" canPlay onPlay={onPlay} onStop={() => {}} onClear={() => {}} onDownload={onDownload} onOpen={onOpen} />);
    ...
    test('shows a Crashed pill in error state with click-to-reset', async () => {
        const onReset = vi.fn();
        render(<Toolbar engineState="error" canPlay onPlay={() => {}} onStop={() => {}} onDownload={() => {}} onOpen={() => {}} onClear={() => {}} onResetEngine={onReset} />);
