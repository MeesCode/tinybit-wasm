...
const loadStyle:   CSSProperties = { ...btnBase, background: '#ED225D', color: '#FFFFFF', borderColor: '#ED225D' };

export interface DemoConfirmProps {
    onLoad():   void;
    onCancel(): void;
}

export function DemoConfirm({ onLoad, onCancel }: DemoConfirmProps) {
    useEffect(() => {
    ...
    return createPortal(
        <div style={overlayStyle} role="dialog" aria-modal="true" aria-label="Load demo?">
            <div style={dialogStyle}>
                <div style={titleStyle}>Load the demo?</div>
                <div style={bodyStyle}>
                ...
                <div style={actionsStyle}>
                    ...
                    <button type="button" style={loadStyle}   onClick={onLoad}>Load demo</button>
                </div>
            </div>
        </div>,
        document.body,
